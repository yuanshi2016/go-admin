...
type SysContractGetPageReq struct {
	...
	NetworkId      string `form:"cetworkId"  search:"type:exact;column:contract_id;table:sys_contract" comment:"主网类型"`
	SysContractOrder
}
...
type SysContractOrder struct {
	...
	NetworkId   string    `form:"networkIdOrder"  search:"type:order;column:contract_id;table:sys_contract"`
